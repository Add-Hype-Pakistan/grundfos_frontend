...
export default function ChooseHomeJourney() {
  return (
    <section className="w-full bg-white p-10 md:p-12 lg:p-16.25">
      <h2 className="font-(family-name:--font-grundfos-sans-extd) font-bold text-[#092844] text-center text-3xl md:text-4xl lg:text-5xl leading-none tracking-normal mb-10 md:mb-12 lg:mb-16">
        Choose The Home Journey
      </h2>
